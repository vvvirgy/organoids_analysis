...
g = tetraploid_genes[1]

dep_by_karyotype = #parallel::mclapply(tetraploid_genes[1:3], function(g) {
  lapply(tetraploid_genes[1:3], function(g) {
  ...
  res = lapply(iterations[1:5], function(i) {
...
saveRDS(dep_by_karyotype, file.path(data_path, 'processed_data/protein/dep_by_karyotype_results_v2.rds'))
