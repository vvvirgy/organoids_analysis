...
source('organoids_analysis/R/functions_utils/get_cnas_muts.R')
...
genes_karyo = readRDS(file.path(data_path, 'processed_data/karyotypes_all_genes_qc.rds'))
...
saveRDS(genes_karyo_muts, file.path(data_path, 'processed_data/karyotypes_mutations_all_genes_qc_ccf.rds'))
