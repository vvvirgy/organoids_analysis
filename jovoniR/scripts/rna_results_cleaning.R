...
df = readRDS("/orfeo/cephfs/scratch/cdslab/gsantacatterina/organoids_analysis/jovoniR/results/RNA/lfc_res_psinorm_stable_FALSE.rds")
...
df_sub %>% saveRDS("/orfeo/cephfs/scratch/cdslab/gsantacatterina/organoids_analysis/jovoniR/results/RNA/lfc_res_clean.rds")
